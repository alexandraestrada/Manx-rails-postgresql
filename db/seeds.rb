...
User.destroy_all
User.create(first_name: 'Alex', last_name: 'SuperStar', email: 'alex@example.com', password: 'password')
items = Item.create([
	{
		name: 'The Megging', 
		color: 'Black', 
